...
exports.MessageRatingService = void 0;
const database_1 = __importDefault(require("../config/database"));
class MessageRatingService {
    static async rateMessage(messageId, userId, rating, reason) {
        try {
    ...
    static async getMessageRating(messageId, userId) {
        try {
            const result = await database_1.default.query(`
    ...
    static async removeMessageRating(messageId, userId) {
        try {
    ...
    static async getMessagesWithRatings(sessionId, userId) {
        try {
            const result = await database_1.default.query(`
        SELECT 
          cm.id,
...
exports.MessageRatingService = MessageRatingService;
//# sourceMappingURL=messageRatingService.js.map